...
*/
/*      Colock                           */
typedef u32     CLK_TypeDef;
/*      Colock Function                  */
typedef void (*RCC_XXXPeriphClockCmd)(u32 clk, FunctionalState state);
/*      Port                             */
typedef GPIO_TypeDef PORT_TypeDef;
/*      Pin                              */
typedef u16 PIN_TypeDef;
/*      Pin Source                       */
typedef u8 PS_TypeDef;
/*      IRQn                             */
typedef u8 IRQN_TypeDef;
/*      IRQ Interrupt id                */
typedef u8 IRQINTID_TypeDef;
/*      IRQ Function                    */
